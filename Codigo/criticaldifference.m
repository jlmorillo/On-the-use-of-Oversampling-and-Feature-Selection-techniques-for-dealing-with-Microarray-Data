...
h = text(0.5*cd/(k-1), 130, 'CD', 'FontSize', 14, 'HorizontalAlignment', 'center');
...
for i=1:ceil(k/2)
   ...
   line([(k-r(i))/(k-1) (k-r(i))/(k-1) 1.2], [100 100-2*(n+1)-8*i 100-2*(n+1)-8*i], 'Color', 'k');
   text(1.2, 100 - 2*(n+1)- 8*i + 3, num2str(r(i)), 'FontSize', 14, 'HorizontalAlignment', 'right');

   text(1.25, 100 - 2*(n+1) - 8*i + 2, labels{idx(i)}, 'FontSize', 16, 'VerticalAlignment', 'middle', 'HorizontalAlignment', 'left');
...
for i=ceil(k/2)+1:k
   ...
   line([(k-r(i))/(k-1) (k-r(i))/(k-1) -0.2], [100 100-2*(n+1)-8*(k-i+1) 100-2*(n+1)-8*(k-i+1)], 'Color', 'k');

   text(-0.2, 100 - 2*(n+1) -8*(k-i+1) + 3, num2str(r(i)), 'FontSize', 14, 'HorizontalAlignment', 'left');

   text(-0.25, 100 - 2*(n+1) -8*(k-i+1) + 2, labels{idx(i)}, 'FontSize', 16, 'VerticalAlignment', 'middle', 'HorizontalAlignment', 'right');
...
for i=1:size(clique,1)
   ...
   line([((k-min(R))/(k-1)) + 0.015 ((k - max(R))/(k-1)) - 0.015], [100-3*i 100-3*i], 'LineWidth', 6, 'Color', 'k');
